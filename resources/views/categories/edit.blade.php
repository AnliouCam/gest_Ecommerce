...
<div class="max-w-xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Modifier la categorie</h1>
        <p class="mt-1 text-sm text-gray-500">{{ $category->name }}</p>
    </div>

    <!-- Form -->
    <form action="{{ route('gerant.categories.update', $category) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-500">Produits dans cette categorie</span>
