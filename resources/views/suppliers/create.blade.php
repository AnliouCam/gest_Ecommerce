...
<div class="max-w-xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Nouveau fournisseur</h1>
        <p class="mt-1 text-sm text-gray-500">Ajoutez un nouveau fournisseur pour vos approvisionnements</p>
    </div>

    <!-- Form -->
    <form action="{{ route('gerant.suppliers.store') }}" method="POST" class="space-y-6">
        @csrf
