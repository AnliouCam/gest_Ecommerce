...
class StockAdjustmentTest extends TestCase
{
    ...
    {
        // Create a product with a specific name that won't match our search
        $testProduct = Product::factory()->create([
            'name' => 'Test Produit ABC',
            'sku' => 'ABC123',
            'quantity' => 50,
        ]);
        ...
        StockAdjustment::factory()->create([
            ...
            'user_id' => $this->gerant->id,
            'reason' => 'Disparition suspecte XYZ',
        ]);
        StockAdjustment::factory()->create([
            'product_id' => $testProduct->id,
            'user_id' => $this->gerant->id,
        ...
        $response->assertViewHas('stockAdjustments', function ($stockAdjustments) {
            return $stockAdjustments->count() === 1
                && $stockAdjustments->first()->reason === 'Disparition suspecte XYZ';
        });
    }
